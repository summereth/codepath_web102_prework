...
const gameCount = GAMES_JSON.reduce((acc, game) => (acc + 1), 0);
...
const unfundedGames = GAMES_JSON.filter((game) => (game.pledged < game.goal));
const unfundedGamesCnt = unfundedGames.length;


// create a string that explains the number of unfunded games using the ternary operator
const displayStr = `A total of $${totalAmount} has been raised for ${gameCount} games. Currently ${unfundedGamesCnt} ${unfundedGamesCnt === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`
...
console.log(`firstGame: ${firstGame.name}, secondGame: ${secondGame.name}`);
